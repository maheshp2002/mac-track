...
import 'package:mac_track/components/themeManager.dart';
...
class SetReminderDialog extends StatefulWidget {
  ...
  const SetReminderDialog({super.key, required this.documentId, required this.reminderName});
            ...
            child: Form(
              ...
              child: Column(
                  ...
                  TextButton(
                    style: ButtonStyle(
                      ...
                      side: WidgetStateProperty.all(
                        BorderSide(
                          color: themeMode == ThemeMode.dark ? AppColors.white : Colors.black54,
                          width: 1,
                        ),
                      ),
                        ...
                        showPicker(
                          ...
                          themeData: Theme.of(context).copyWith(
                            timePickerTheme: TimePickerThemeData(
                              ...
                              hourMinuteTextColor: theme.textTheme.labelSmall!.color,
                    ...
                    child: Text("$_time", style: theme.textTheme.bodySmall),
                ...
                child: ElevatedButton(
                  ...
                  style: ButtonStyle(
                    backgroundColor: WidgetStateProperty.all(AppColors.secondaryGreen),
                  ),
